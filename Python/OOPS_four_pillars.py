...
class Fresher:
    ...
    # An "intro" method
    def intro(self):
        print("Hello All!\nI'm {} from {}. My registration number is {}".format(self.name, self.branch, self.reg_no))
...
class Child(Parent):
    ...
    def display(self):
        ...
        print("My name: ", new_child.getName(), "\nMy age: ", new_child.getAge())   # can access getName() method from "Parent" class throught inheritence
